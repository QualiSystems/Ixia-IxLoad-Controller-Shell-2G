...
class IxLoadControllerShell2G(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'IxLoad Controller Shell 2G'
        self._name = name
    ...
    def apikey(self):
        ...
        :rtype: str
        """
        return self.attributes['IxLoad Controller Shell 2G.ApiKey'] if 'IxLoad Controller Shell 2G.ApiKey' in self.attributes else None

    @apikey.setter
    def apikey(self, value):
        """
        IxLoad ApiKey for authenticated IxLoad gateways.
        :type value: str
        """
        self.attributes['IxLoad Controller Shell 2G.ApiKey'] = value
    ...
    def controller_version(self):
        ...
        :rtype: str
        """
        return self.attributes['IxLoad Controller Shell 2G.Controller Version'] if 'IxLoad Controller Shell 2G.Controller Version' in self.attributes else None

    @controller_version.setter
    def controller_version(self, value):
        """
        IxLoad gateway version.
        :type value: str
        """
        self.attributes['IxLoad Controller Shell 2G.Controller Version'] = value
    ...
    def license_server(self):
        ...
        :rtype: str
        """
        return self.attributes['IxLoad Controller Shell 2G.License Server'] if 'IxLoad Controller Shell 2G.License Server' in self.attributes else None

    @license_server.setter
    def license_server(self, value='localhost'):
        """
    ...
    def user(self):
        ...
        :rtype: str
        """
        return self.attributes['IxLoad Controller Shell 2G.User'] if 'IxLoad Controller Shell 2G.User' in self.attributes else None
    ...
    def user(self, value):
        ...
        :type value: str
        """
        self.attributes['IxLoad Controller Shell 2G.User'] = value
    ...
    def password(self):
        ...
        :rtype: string
        """
        return self.attributes['IxLoad Controller Shell 2G.Password'] if 'IxLoad Controller Shell 2G.Password' in self.attributes else None
    ...
    def password(self, value):
        ...
        :type value: string
        """
        self.attributes['IxLoad Controller Shell 2G.Password'] = value
    ...
    def address(self):
        ...
        :rtype: str
        """
        return self.attributes['IxLoad Controller Shell 2G.Address'] if 'IxLoad Controller Shell 2G.Address' in self.attributes else None
    ...
    def address(self, value):
        ...
        :type value: str
        """
        self.attributes['IxLoad Controller Shell 2G.Address'] = value
    ...
    def client_install_path(self):
        ...
        :rtype: str
        """
        return self.attributes['IxLoad Controller Shell 2G.Client Install Path'] if 'IxLoad Controller Shell 2G.Client Install Path' in self.attributes else None
    ...
    def client_install_path(self, value):
        ...
        :type value: str
        """
        self.attributes['IxLoad Controller Shell 2G.Client Install Path'] = value
    ...
    def controller_tcp_port(self):
        ...
        :rtype: str
        """
        return self.attributes['IxLoad Controller Shell 2G.Controller TCP Port'] if 'IxLoad Controller Shell 2G.Controller TCP Port' in self.attributes else None
    ...
    def controller_tcp_port(self, value):
        ...
        :type value: str
        """
        self.attributes['IxLoad Controller Shell 2G.Controller TCP Port'] = value
    ...
    def test_files_location(self):
        ...
        :rtype: str
        """
        return self.attributes['IxLoad Controller Shell 2G.Test Files Location'] if 'IxLoad Controller Shell 2G.Test Files Location' in self.attributes else None
    ...
    def test_files_location(self, value):
        ...
        :type value: str
        """
        self.attributes['IxLoad Controller Shell 2G.Test Files Location'] = value
