...
class IxLoadControllerShell2G(object):
    ...
    def apikey(self):
        ...
        """
        return (
            self.attributes["IxLoad Controller Shell 2G.ApiKey"]
            if "IxLoad Controller Shell 2G.ApiKey" in self.attributes
            else None
        )
    ...
    def controller_version(self):
        ...
        """
        return (
            self.attributes["IxLoad Controller Shell 2G.Controller Version"]
            if "IxLoad Controller Shell 2G.Controller Version" in self.attributes
            else None
        )
    ...
    def license_server(self):
        ...
        """
        return (
            self.attributes["IxLoad Controller Shell 2G.License Server"]
            if "IxLoad Controller Shell 2G.License Server" in self.attributes
            else None
        )
    ...
    def licensing_mode(self):
        ...
        """
        return (
            self.attributes["IxLoad Controller Shell 2G.Licensing Mode"]
            if "IxLoad Controller Shell 2G.Licensing Mode" in self.attributes
            else None
        )
    ...
    def user(self):
        ...
        """
        return (
            self.attributes["IxLoad Controller Shell 2G.User"]
            if "IxLoad Controller Shell 2G.User" in self.attributes
            else None
        )
    ...
    def password(self):
        ...
        """
        return (
            self.attributes["IxLoad Controller Shell 2G.Password"]
            if "IxLoad Controller Shell 2G.Password" in self.attributes
            else None
        )
    ...
    def address(self):
        ...
        """
        return (
            self.attributes["IxLoad Controller Shell 2G.Address"]
            if "IxLoad Controller Shell 2G.Address" in self.attributes
            else None
        )
    ...
    def client_install_path(self):
        ...
        """
        return (
            self.attributes["IxLoad Controller Shell 2G.Client Install Path"]
            if "IxLoad Controller Shell 2G.Client Install Path" in self.attributes
            else None
        )
    ...
    def controller_tcp_port(self):
        ...
        """
        return (
            self.attributes["IxLoad Controller Shell 2G.Controller TCP Port"]
            if "IxLoad Controller Shell 2G.Controller TCP Port" in self.attributes
            else None
        )
    ...
    def test_files_location(self):
        ...
        """
        return (
            self.attributes["IxLoad Controller Shell 2G.Test Files Location"]
            if "IxLoad Controller Shell 2G.Test Files Location" in self.attributes
            else None
        )
